import type { FormData, RankingParams, RankingResponse } from "../types";

export const BASE_URL = import.meta.env.VITE_BASE_URL || "https://bbs.toof.jp";
export const IMAGE_BASE_URL =
  import.meta.env.VITE_IMAGE_BASE_URL || `${BASE_URL}/images`;
...
export async function getRanking(
  ...
  if (params.name_and_trip)
    queryParams.append("name_and_trip", params.name_and_trip);
  if (params.oekaki !== undefined)
    queryParams.append("oekaki", params.oekaki.toString());
